...
urlpatterns = [
    ...
    path("requests-total/<int:year>/", charts.get_requests_total_chart),
    path("requests/<int:year>/", charts.get_requests_chart),
    path("duration-per-request/<int:year>/", charts.get_duration_per_request_chart),
    path("requests-by-schema/<int:year>/", charts.get_requests_by_schema_chart),
    ...
    path("user-registrations-active/<int:year>/", charts.get_active_user_registrations_chart),  
    ...
    path("top-tools-ifc2x3/<int:year>/", charts.get_top_tools_ifc2x3_chart),
    path("top-tools-ifc4/<int:year>/", charts.get_top_tools_ifc4_chart),
    path("top-tools-ifc4x3/<int:year>/", charts.get_top_tools_ifc4x3_chart),
    path("requests-per-schema-vendor-ifc2x3/<int:year>/", charts.get_requests_by_schema_vendor_ifc2x3_chart),
    path("requests-per-schema-vendor-ifc4/<int:year>/", charts.get_requests_by_schema_vendor_ifc4_chart),
    path("requests-per-schema-vendor-ifc4x3/<int:year>/", charts.get_requests_by_schema_vendor_ifc4x3_chart),
